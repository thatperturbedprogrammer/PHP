...
<body class="p-2 m-4 border border-success rounded">
    ...
    else
    {
        ?>
            <div class="container text-center">
                <h1 class="text-danger mb-2" align="center"><b>Verification Pending</b></h1>
                <span class="text-danger text-center"><em>You are not verified, Please Logout and check in after some time...</em></span>
